...
<head>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $('body').delegate('#add_children', 'click', function() {
          ...
          $('#child_add').append('<div class="form_row"><div class="form_inline">Child '+child_count+'<div class="input_placeholder children" ><input type="text" class="child_first_name name_validate"  placeholder="firstname"></div><div class="input_placeholder children" ><input type="text" class="child_last_name name_validate"  placeholder="lastname" value = '+lastname+'></div><div class="input_placeholder children" ><input type="number" class="child_age num_validate" placeholder="Age"></div><div class="form_inline children cross"></div></div></div>');
     ...
     $('body').delegate('#wcback', 'click', function() {
  ...
  <style type="text/css">
      ...
      .form_row{width: 100%;display: inline-block;height: 6vh;line-height: 6vh;margin-left: 4vw;color: #6b6b6b;}
      .form_spacer{height: 1.6vh;}
      .form_smallspace{height: auto;}
      .form_inline{display: inline-block;}
      .show_row{height: 7vh;line-height: 7vh;border-bottom: 1px solid rgb(240,240,240);font-size: 5vw; text-align: center;font-family: 'Muli', sans-serif;}
      ...
      .children{ display: inline-block; width: 20vw; margin-bottom: 4vh; margin-left: 2vw;}
      ...
      #add_children:hover{cursor: pointer;}
