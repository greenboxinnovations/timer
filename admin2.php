	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('body').delegate('tr','click',function(){
				var ride_total 	= $(this).find('.ride_total').text();
				var ride_rate 	= $(this).find('.ride_rate').text();
				var ride_num 	= $(this).find('.ride_num').text();
				var ride_id 	= $(this).attr('ride_id');				

				if (ride_id != undefined) {
					showCrunch();
					$('#old_total').text(ride_total);
					$('#final_total').text(ride_total);
					$('#crunch_rate').val(ride_rate);
					$('#ride_id').val(ride_id);
				}
