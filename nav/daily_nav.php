...
<div id="cntrl_bar">
	<div id="day_cntrls">
		<div id="date_selector"><input type="date" id="date_input"></div>
	...
	<div class="viewpager_header">
          <div class="viewpager_tabs tab_active" shift="a">SHIFT A</div>
          <div class="viewpager_tabs" shift="b">SHIFT B</div>
          <div class="viewpager_tabs" shift="c">SHIFT C</div>
    </div>
</div>