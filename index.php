...
<head>
	...
	<style type="text/css">
		*{padding: 0;margin: 0;}
		...
		#start_btn{width: 60px;display: inline-block;text-align: center;display: none;}
		#stop_btn{width: 60px;display: inline-block;text-align: center;display: none;}
		#logout{width: 100px;display: inline-block;text-align: center;}
		#logout:hover,#start_btn:hover,#stop_btn:hover{color: rgb(100,100,100);cursor: pointer;}
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#logout').on('click', function(){
				window.location = "exe/logout.php";
			});
		});
	</script>
</head>
